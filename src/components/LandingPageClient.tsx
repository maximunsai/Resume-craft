      ...
      <section className="pt-16 pb-24 px-6">
        <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className={`transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
              ...
              <h1 className="font-poppins text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">Forge Your Future with<span className="text-yellow-400"> AI-Crafted Resumes</span></h1>
              <p className="text-xl text-gray-400 mb-8 leading-relaxed">Our master AI forge transforms your career raw materials into interview-winning masterpieces. Choose from 50+ battle-tested templates and land your dream job 3x faster.</p>
