...
export default function InterviewSessionPage() {
        ...
        try {
            ...
            while (true) {
                ...
                useInterviewStore.setState(state => {
                    ...
                    if (lastMessage?.sender === 'AI') { lastMessage.text += decoder.decode(value, { stream: true }); return { messages: [...state.messages] }; }
                    return state;
                });
            }
        } catch (error) {
            ...
            useInterviewStore.setState(state => {
                const lastMessage = state.messages[state.messages.length - 1];
                if (lastMessage?.sender === 'AI') { lastMessage.text = "Sorry, I encountered a connection issue. Please try again."; }
    ...
    // --- Conditional UI: Renders the "Start" overlay first ---
    if (!sessionActive) {
        return (
    ...
    // --- Main Chat UI: Renders after the session is active ---
    return (
