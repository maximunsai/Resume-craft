...
export default function InterviewSessionPage() {
    ...
    useEffect(() => {
        // This is the dedicated speaking effect. It prevents loops.
        if (!sessionActive || isThinking) return;
        const lastMessageIndex = messages.length - 1;
        const lastMessage = messages[lastMessageIndex];
        if (lastMessage && lastMessage.sender === 'AI' && lastMessage.text && lastSpokenMessageIndex !== lastMessageIndex) {
    ...
    // --- Handlers ---
    const sendApiRequest = async (conversationHistory: Message[], currentStage: string) => {
        setIsThinking(true);
        ...
        try {
            ...
            while (true) {
                ...
                const action = conversationHistory.length === 0 ? startNewInterview : (text: string) => useInterviewStore.setState(state => {
    ...
    const handleStartSession = () => {
        ...
        // Fetch the very first question from the AI
        sendApiRequest([], useInterviewStore.getState().stage);
    };
    ...
    const handleSubmitAnswer = () => {
        ...
        setUserInput('');
        sendApiRequest([...messages, userMessage], stage);
    };
        ...
        return (
            <div className="max-w-4xl mx-auto p-8 flex flex-col items-center justify-center h-[calc(100vh-65px)] text-center">
                <div className="bg-gray-800 p-8 rounded-xl border border-gray-700 w-full max-w-lg">
                    ...
                    <p className="text-gray-400 mb-6">Your AI interviewer, Forge, is ready to begin. Select your preferred voice and click start.</p>
